  ...
  return (
    <div className="bg-[#111111] py-10 px-6 sm:px-10 shadow-2xl rounded-2xl border border-[#1F1F1F] w-full max-w-md relative overflow-hidden">
      ...
      <div className="mb-8 text-center">
        <h2 className="text-2xl font-bold tracking-tight text-foreground mb-2">Access Terminal</h2>
          ...
          >
            ...
            <div className="text-center">
               <button 
                 ...
                 disabled={loading}
                 className="text-[10px] uppercase tracking-widest font-bold text-[#A1A1AA] hover:text-foreground transition-colors"
               >
                 Change Number
               </button>
            </div>
      ...
      <div className="mt-8">
        ...
        <div className="mt-6">
          <button className="w-full flex justify-center items-center gap-3 py-3 px-4 border border-[#1F1F1F] rounded-xl shadow-sm text-xs font-bold tracking-widest uppercase text-foreground bg-[#000000] hover:bg-[#1F1F1F] focus:outline-none transition-colors">
